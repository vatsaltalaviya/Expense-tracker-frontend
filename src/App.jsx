...
const App = () => {
  ...
  return (
    <div className="flex relative flex-col md:flex-row h-screen bg-zinc-100">
      ...
      <div className="absolute bottom-0 left-0  flex md:hidden w-full z-50">
        <div className="bg-primary px-2 w-full">
          <div className="w-full flex justify-evenly space-x-3 py-0.5 px-2">
            ...
            <button
              ...
              className="flex nav transition-all text-white/45 duration-300 gap-2 rounded hover:bg-white hover:text-black items-center"
            >
...
const LogoutUser = ({ onYes, onCancel }) => {
  return (
    <div className="w-full flex items-center justify-center h-screen bg-black/5 fixed top-0 left-0">
      <div className=" px-2 py-2 text-black bg-white rounded-lg w-82">
        ...
        <div className="flex justify-center w-full gap-x-2">
          <button
            onClick={() => onYes()}
            className="bg-emerald-500 w-full rounded px-2 py-1 text-lg font-medium text-white"
          >
            Yes
          </button>
          <button
            onClick={() => onCancel()}
            className="bg-red-500 w-full rounded px-2 py-1 text-lg font-medium text-white"
          >
            Cancel
          </button>
        </div>
